...
create table aparelhos(
    id_aparelho int not null primary key auto_increment,
    nome varchar(50) not null
);
...
LOAD DATA INFILE 'D:/Senai2022/2DES/BackEnd/Aula03/academia/docs/alunos.CSV'
INTO TABLE alunos
...
LOAD DATA INFILE 'D:/Senai2022/2DES/BackEnd/Aula03/academia/docs/telefones.CSV'
...
LOAD DATA INFILE 'D:/Senai2022/2DES/BackEnd/Aula03/academia/docs/aparelhos.CSV'
...
LOAD DATA INFILE 'D:/Senai2022/2DES/BackEnd/Aula03/academia/docs/exercicios.CSV'
...
LOAD DATA INFILE 'D:/Senai2022/2DES/BackEnd/Aula03/academia/docs/fichas.CSV'
INTO TABLE fichas
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
select a.id_aluno, a.nome, a.nascimento, a.sexo, a.peso, t.numero from alunos a
