...
LOAD DATA INFILE 'D:/well/senai2022/2des/pwbe/aula04/entregas/docs/clientes.csv'
INTO TABLE clientes
...
LOAD DATA INFILE 'D:/well/senai2022/2des/pwbe/aula04/entregas/docs/telefones.csv'
...
LOAD DATA INFILE 'D:/well/senai2022/2des/pwbe/aula04/entregas/docs/produtos.csv'
INTO TABLE produtos
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/well/senai2022/2des/pwbe/aula04/entregas/docs/entregadores.csv'
...
LOAD DATA INFILE 'D:/well/senai2022/2des/pwbe/aula04/entregas/docs/pedidos.csv'
INTO TABLE pedidos
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/well/senai2022/2des/pwbe/aula04/entregas/docs/itens.csv'
INTO TABLE itens
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
-- Salvando a Consulta Cliente com Telefone
